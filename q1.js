...
//these are variables
  var url= 'http://galvanize-cors-proxy.herokuapp.com/http://whoismyrepresentative.com/getall_mems.php?zip=';
  var $userInput;
...
// get userInput from input field on submit .val()
// store userInput into userInput
// concatenate url + user input -- in get request (shortened url + userInput + "&output=json")
